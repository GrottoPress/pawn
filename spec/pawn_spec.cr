...
describe Pawn do
  describe "#count" do
    it "returns 0 for safe password" do
      password = "ZWkWBX3deXkU29TdYUeGVh8n"
      ...
      Pawn.count(password).should eq(0)
    end

    it "returns breach count for unsafe password" do
      password = "password"
      count = 3861493
      ...
      response = IO::Memory.new <<-TEXT
        ...
        1E4C9B93F3F0682250B6CF8331B7EE68FD8:#{count}
      ...
      Pawn.count(password).should eq(count)
    end
  end
  ...
  describe "#pwned?" do
    it "accepts safe password" do
      ...
      Pawn.pwned?(password).should be_false
    end
    ...
    it "rejects unsafe password" do
      ...
      Pawn.pwned?(password).should be_true
    end
  end
end
